<template>
  <div class="UpdateCompetition">
    ...
    <el-form class="UpdateCompetitionForm" :model="UpdateCompetitionForm">
      <el-form-item>
        Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<el-input class="el-input_edit" type="name"
                                                                       v-model="UpdateCompetitionForm.name"></el-input>
      </el-form-item>
      <el-form-item>
        Address:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<el-input class="el-input_edit"
                                                        v-model="UpdateCompetitionForm.address"></el-input>
      </el-form-item>
      <el-form-item>
        StartTime:&nbsp;&nbsp;&nbsp;<el-input class="el-input_edit"
                                              v-model="UpdateCompetitionForm.startTime"></el-input>
      </el-form-item>
      <el-form-item>
        EndTime:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<el-input class="el-input_edit"
                                                        v-model="UpdateCompetitionForm.endTime"></el-input>
      </el-form-item>
      <el-form-item>
        MaxPeople:&nbsp;<el-input class="el-input_edit" v-model="UpdateCompetitionForm.allPerson"></el-input>
      </el-form-item>
      Level:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<el-select class="el-select_edit"
                                                                       v-model="UpdateCompetitionForm.level"
                                                                       placeholder="Please">
      <el-option
      ...
      <ul>
        <li v-for="p in Rank" :key="p.userId">
          ...
          <!-- 获取用户的姓名 -->
          Name:{{ p.username }}
          <el-input class="score_input" v-model="p.score"></el-input>
          <!-- 点击提交时 返回到成绩表中-->
        </li>
      </ul>
      <el-form-item>
...
export default {
  ...
  methods: {
    ...
    Submit() {
      ...
      console.log("@submitRank",this.Rank)
    ...
    getGradeInfo() {
      ...
      this.$axios.get("/activity-records/activityuser/" + activityId).then((resp)=>{
        console.log("userInfoData",resp)
        if(resp.data.code === 200) {
          for(let i = 0 ; i < resp.data.data.length;i++){
            this.Rank[i].userId = resp.data.data[i].userId
          }
        }
      })
    }
